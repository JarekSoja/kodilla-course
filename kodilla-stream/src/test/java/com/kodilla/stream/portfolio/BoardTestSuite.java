...
public class BoardTestSuite {
    ...
    @Test
    public void testAddTaskListFindUserTask(){
        //Given
        Board project = prepareTestData();
        //When
    ...
    public void testAddTaskListAverageWorkingOnTask(){
        ...
        long tasksInProgress = project.getTaskLists().stream()
                ...
                .flatMap(tl -> tl.getTasks().stream())
                .count();
        long daysOfWork = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
                .flatMap(tl -> tl.getTasks().stream())
                .map(t -> t.getCreated())
        ...
        double averageDaysOfWork = daysOfWork / tasksInProgress;

        //Then
        Assert.assertEquals(10, averageDaysOfWork, 0);
        Assert.assertEquals(3, tasksInProgress);
        Assert.assertEquals(30, daysOfWork);
    }
